...
function isBlockScopeBoundary(node) {
  switch (node.kind) {
    case import_typescript18.default.SyntaxKind.Block: {
      const parent = node.parent;
      return parent.kind !== import_typescript18.default.SyntaxKind.CatchClause && // blocks inside SourceFile are block scope boundaries
      (parent.kind === import_typescript18.default.SyntaxKind.SourceFile || // blocks that are direct children of a function scope boundary are no scope boundary
      // for example the FunctionBlock is part of the function scope of the containing function
      !isFunctionScopeBoundary(parent)) ? 2 /* Block */ : 0 /* None */;
    }
    case import_typescript18.default.SyntaxKind.ForStatement:
    case import_typescript18.default.SyntaxKind.ForInStatement:
    case import_typescript18.default.SyntaxKind.ForOfStatement:
    case import_typescript18.default.SyntaxKind.CaseBlock:
    case import_typescript18.default.SyntaxKind.CatchClause:
    case import_typescript18.default.SyntaxKind.WithStatement:
      return 2 /* Block */;
    default:
      return 0 /* None */;
  }
...
function identifierToKeywordKind(node) {
  return "identifierToKeywordKind" in import_typescript19.default ? import_typescript19.default.identifierToKeywordKind(node) : (
    // eslint-disable-next-line deprecation/deprecation
    node.originalKeywordKind
  );
}
function canHaveDecorators(node) {
  return "canHaveDecorators" in import_typescript19.default ? import_typescript19.default.canHaveDecorators(node) : "decorators" in node;
}
function getDecorators(node) {
  return "getDecorators" in import_typescript19.default ? import_typescript19.default.getDecorators(node) : node.decorators;
}
...
function getDeclarationDomain(node) {
  switch (node.parent.kind) {
    case import_typescript20.default.SyntaxKind.TypeParameter:
    case import_typescript20.default.SyntaxKind.InterfaceDeclaration:
    case import_typescript20.default.SyntaxKind.TypeAliasDeclaration:
      return 2 /* Type */;
    case import_typescript20.default.SyntaxKind.ClassDeclaration:
    case import_typescript20.default.SyntaxKind.ClassExpression:
      return 2 /* Type */ | 4 /* Value */;
    case import_typescript20.default.SyntaxKind.EnumDeclaration:
      return 7 /* Any */;
    case import_typescript20.default.SyntaxKind.NamespaceImport:
    case import_typescript20.default.SyntaxKind.ImportClause:
      return 7 /* Any */ | 8 /* Import */;
    case import_typescript20.default.SyntaxKind.ImportEqualsDeclaration:
    case import_typescript20.default.SyntaxKind.ImportSpecifier:
      return node.parent.name === node ? 7 /* Any */ | 8 /* Import */ : void 0;
    case import_typescript20.default.SyntaxKind.ModuleDeclaration:
      return 1 /* Namespace */;
    case import_typescript20.default.SyntaxKind.Parameter:
      if (node.parent.parent.kind === import_typescript20.default.SyntaxKind.IndexSignature || identifierToKeywordKind(node) === import_typescript20.default.SyntaxKind.ThisKeyword) {
        return;
      }
    case import_typescript20.default.SyntaxKind.BindingElement:
    case import_typescript20.default.SyntaxKind.VariableDeclaration:
      return node.parent.name === node ? 4 /* Value */ : void 0;
    case import_typescript20.default.SyntaxKind.FunctionDeclaration:
    case import_typescript20.default.SyntaxKind.FunctionExpression:
      return 4 /* Value */;
  }
}
...
function unwrapParentheses(node) {
  while (node.kind === import_typescript21.default.SyntaxKind.ParenthesizedExpression) {
    node = node.expression;
  }
  return node;
}
function getPropertyName(propertyName) {
  if (propertyName.kind === import_typescript21.default.SyntaxKind.ComputedPropertyName) {
    const expression = unwrapParentheses(propertyName.expression);
    if (import_typescript21.default.isPrefixUnaryExpression(expression)) {
      let negate = false;
      switch (expression.operator) {
        case import_typescript21.default.SyntaxKind.MinusToken:
          negate = true;
        case import_typescript21.default.SyntaxKind.PlusToken:
          return import_typescript21.default.isNumericLiteral(expression.operand) ? `${negate ? "-" : ""}${expression.operand.text}` : import_typescript21.default.isBigIntLiteral(expression.operand) ? `${negate ? "-" : ""}${expression.operand.text.slice(0, -1)}` : void 0;
        default:
          return;
      }
    }
    if (import_typescript21.default.isBigIntLiteral(expression)) {
  ...
  return propertyName.kind === import_typescript21.default.SyntaxKind.PrivateIdentifier ? void 0 : propertyName.text;
}
...
function getUsageDomain(node) {
  const parent = node.parent;
  switch (parent.kind) {
    case import_typescript22.default.SyntaxKind.TypeReference:
      return identifierToKeywordKind(node) !== import_typescript22.default.SyntaxKind.ConstKeyword ? 2 /* Type */ : void 0;
    case import_typescript22.default.SyntaxKind.ExpressionWithTypeArguments:
      return parent.parent.token === import_typescript22.default.SyntaxKind.ImplementsKeyword || parent.parent.parent.kind === import_typescript22.default.SyntaxKind.InterfaceDeclaration ? 2 /* Type */ : 4 /* Value */;
    case import_typescript22.default.SyntaxKind.TypeQuery:
      return 5 /* ValueOrNamespace */ | 8 /* TypeQuery */;
    case import_typescript22.default.SyntaxKind.QualifiedName:
      if (parent.left === node) {
        if (getEntityNameParent(parent).kind === import_typescript22.default.SyntaxKind.TypeQuery) {
          return 1 /* Namespace */ | 8 /* TypeQuery */;
        }
        return 1 /* Namespace */;
      }
      break;
    case import_typescript22.default.SyntaxKind.ExportSpecifier:
      if (parent.propertyName === void 0 || parent.propertyName === node) {
        return 7 /* Any */;
      }
      break;
    case import_typescript22.default.SyntaxKind.ExportAssignment:
      return 7 /* Any */;
    case import_typescript22.default.SyntaxKind.BindingElement:
      if (parent.initializer === node) {
        return 5 /* ValueOrNamespace */;
      }
      break;
    case import_typescript22.default.SyntaxKind.Parameter:
    case import_typescript22.default.SyntaxKind.EnumMember:
    case import_typescript22.default.SyntaxKind.PropertyDeclaration:
    case import_typescript22.default.SyntaxKind.VariableDeclaration:
    case import_typescript22.default.SyntaxKind.PropertyAssignment:
    case import_typescript22.default.SyntaxKind.PropertyAccessExpression:
    case import_typescript22.default.SyntaxKind.ImportEqualsDeclaration:
      if (parent.name !== node) {
        return 5 /* ValueOrNamespace */;
      }
      break;
    case import_typescript22.default.SyntaxKind.JsxAttribute:
    case import_typescript22.default.SyntaxKind.FunctionDeclaration:
    case import_typescript22.default.SyntaxKind.FunctionExpression:
    case import_typescript22.default.SyntaxKind.NamespaceImport:
    case import_typescript22.default.SyntaxKind.ClassDeclaration:
    case import_typescript22.default.SyntaxKind.ClassExpression:
    case import_typescript22.default.SyntaxKind.ModuleDeclaration:
    case import_typescript22.default.SyntaxKind.MethodDeclaration:
    case import_typescript22.default.SyntaxKind.EnumDeclaration:
    case import_typescript22.default.SyntaxKind.GetAccessor:
    case import_typescript22.default.SyntaxKind.SetAccessor:
    case import_typescript22.default.SyntaxKind.LabeledStatement:
    case import_typescript22.default.SyntaxKind.BreakStatement:
    case import_typescript22.default.SyntaxKind.ContinueStatement:
    case import_typescript22.default.SyntaxKind.ImportClause:
    case import_typescript22.default.SyntaxKind.ImportSpecifier:
    case import_typescript22.default.SyntaxKind.TypePredicate:
    case import_typescript22.default.SyntaxKind.MethodSignature:
    case import_typescript22.default.SyntaxKind.PropertySignature:
    case import_typescript22.default.SyntaxKind.NamespaceExportDeclaration:
    case import_typescript22.default.SyntaxKind.NamespaceExport:
    case import_typescript22.default.SyntaxKind.InterfaceDeclaration:
    case import_typescript22.default.SyntaxKind.TypeAliasDeclaration:
    case import_typescript22.default.SyntaxKind.TypeParameter:
    case import_typescript22.default.SyntaxKind.NamedTupleMember:
      break;
    default:
      return 5 /* ValueOrNamespace */;
  }
...
function getEntityNameParent(name) {
  ...
  while (parent.kind === import_typescript22.default.SyntaxKind.QualifiedName) {
