    ...
    create(context) {
        return {
            TSNonNullExpression(node) {
                ...
                const nonNullOperator = context.sourceCode.getTokenAfter(node.expression, util_1.isNonNullAssertionPunctuator);
                        ...
                        if (node.parent.computed) {
                            ...
                            suggest.push({
                                ...
                                fix(fixer) {
                                    // x!.y?.z
                                    //   ^ punctuator
                                    const punctuator = context.sourceCode.getTokenAfter(nonNullOperator);
                                    return [
